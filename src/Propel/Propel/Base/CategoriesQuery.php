 ...
 *
 *
 * @method     ChildCategoriesQuery orderByIdCategories($order = Criteria::ASC) Order by the id_categories column
 * @method     ChildCategoriesQuery orderByTitle($order = Criteria::ASC) Order by the title column
 *
 * @method     ChildCategoriesQuery groupByIdCategories() Group by the id_categories column
 ...
 *
 * @method     ChildCategories findOneByIdCategories(int $id_categories) Return the first ChildCategories filtered by the id_categories column
 * @method     ChildCategories findOneByTitle(string $title) Return the first ChildCategories filtered by the title column *
 ...
 *
 * @method     ChildCategories requireOneByIdCategories(int $id_categories) Return the first ChildCategories filtered by the id_categories column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildCategories[]|ObjectCollection findByIdCategories(int $id_categories) Return ChildCategories objects filtered by the id_categories column
 * @method     ChildCategories[]|ObjectCollection findByTitle(string $title) Return ChildCategories objects filtered by the title column
...
abstract class CategoriesQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_categories, title FROM categories WHERE id_categories = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(CategoriesTableMap::COL_ID_CATEGORIES, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(CategoriesTableMap::COL_ID_CATEGORIES, $keys, Criteria::IN);
    }
    ...
    public function filterByIdCategories($idCategories = null, $comparison = null)
    {
        if (is_array($idCategories)) {
            ...
            if (isset($idCategories['min'])) {
                $this->addUsingAlias(CategoriesTableMap::COL_ID_CATEGORIES, $idCategories['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idCategories['max'])) {
                $this->addUsingAlias(CategoriesTableMap::COL_ID_CATEGORIES, $idCategories['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoriesTableMap::COL_ID_CATEGORIES, $idCategories, $comparison);
    }
    ...
    {
        if ($categories) {
            $this->addUsingAlias(CategoriesTableMap::COL_ID_CATEGORIES, $categories->getIdCategories(), Criteria::NOT_EQUAL);
        }
