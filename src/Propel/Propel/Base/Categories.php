...
abstract class Categories implements ActiveRecordInterface
{
    ...
    public function setIdCategories($v)
    {
        ...
        if ($this->id_categories !== $v) {
            ...
            $this->modifiedColumns[CategoriesTableMap::COL_ID_CATEGORIES] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CategoriesTableMap::translateFieldName('IdCategories', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_categories = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CategoriesTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoriesTableMap::COL_ID_CATEGORIES)) {
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdCategories($arr[$keys[0]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoriesTableMap::COL_ID_CATEGORIES)) {
            $criteria->add(CategoriesTableMap::COL_ID_CATEGORIES, $this->id_categories);
        }
        if ($this->isColumnModified(CategoriesTableMap::COL_TITLE)) {
    ...
    {
        $validPk = null !== $this->getIdCategories();
    ...
    /**
     * Generic method to set the primary key (id_categories column).
     *
    ...
    {
        return null === $this->getIdCategories();
    }
