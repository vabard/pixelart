...
abstract class Users implements ActiveRecordInterface
{
    ...
    public function setIdUsers($v)
    {
        ...
        if ($this->id_users !== $v) {
            $this->id_users = $v;
            $this->modifiedColumns[UsersTableMap::COL_ID_USERS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UsersTableMap::translateFieldName('IdUsers', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_ID_USERS)) {
            $criteria->add(UsersTableMap::COL_ID_USERS, $this->id_users);
        }
        if ($this->isColumnModified(UsersTableMap::COL_USERNAME)) {
    ...
    /**
     * Generic method to set the primary key (id_users column).
     *
